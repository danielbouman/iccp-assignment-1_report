...
\begin{Figure}
  \centerfloat
     \includegraphics[trim = 5mm 4mm 10mm 5mm, clip, scale=0.44]{instanteneous_pressure.eps}
...
\begin{Figure}
 ...
 \captionof{figure}{Comparison between the instanteneous specific heat for gaseous $(\rho = 0.3$,$T_d = 3)$ and liquid ($\rho = 0.8$,$T_d = 1$) argon. }\label{fig:specific_heat}
\end{Figure}
